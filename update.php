...
<center>
        ...
        <label for="">Proudouit:</label>
        <input type="text" value="<?php echo $data['Proudouit'] ?>" name="proudouit"><br>
        <label for="">Operation :</label>
        <input type="text" value="<?php echo $data['Operation'] ?>" name="operation" id=""><br>
        <label for="">Name:</label>
        <input type="text" value="<?php echo $data['Name'] ?>" name="name"><br>
        <label for="">Phone:</label>
        <input type="text" value="<?php echo $data['Phone'] ?>" name="phone"><br>
        <label for="">Adresse:</label>
        <input type="text" value="<?php echo $data['Adresse'] ?>" name="Adresse"><br>
